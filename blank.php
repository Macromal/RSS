...
<form class="modal-content animate" action="sajatfeed_create.php" method="post" enctype="multipart/form-data">
<div class="container"> 
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
											<label for="form_message">Cím</label> </br>
											<input type="text" class="form-control form-control-user" id="title"  name="title"  required></br>
											<label for="form_message">Rövid leírás</label> </br>
											<input type="text" class="form-control form-control-user" id="description"  name="description"  required></br>										
										<label for="form_message">Szöveg</label> 
										<textarea id="message" name="message" class="form-control"  rows="4"  data-error="Please, leave us a message." required></textarea> 
										</div>
                                    </div>	
                                    <div class="col-md-12"> 
									<button class="btn btn-success btn-send pt-2 btn-block"  type="submit">Beküldés</button>
									</div>
                                </div>
                            </div>
...
$query = "select * from feeds where feltoltotte = '$fsz' and link is  null order by letrehozva desc" ;
			...
			while($row = pg_fetch_row($result))
			{
				...
				echo "<td>" .$row[5] ."</td>";
				echo "<td class=\"cell-hyphens\" style=\"width:35%;\">" .$row[3] ."</td>";
...
<form id="editForm" method="post">
    ...
    <label for="input2">Rövid leírás:</label><br>
    <input type="text" id="leiras_mod" name="leiras_mod" style="width: 750px;"><br><br>
    <label for="textarea">Szöveg:</label><br>
    <textarea id="szoveg_mod" name="szoveg_mod" rows="10" cols="180"></textarea><br><br>
...
<script>
    function submitForm(action) {
        ...
        document.getElementById('editForm').action = 'feed_edit.php?action=' + action;
        // Elküldjük a formot
     ...
     var table = document.getElementById("dataTable2"),rIndex;
            ...
            for(var i = 1; i < table.rows.length; i++)
            {
                table.rows[i].onclick = function()
                {
					...
					document.getElementById("leiras_mod").value = this.cells[2].innerHTML; 
					document.getElementById("szoveg_mod").value = this.cells[3].innerHTML;
